    ...
    <div className="container py-10 md:py-16">
      ...
      <section className="grid grid-cols-1 gap-8 border-t border-[var(--line)] py-12 md:grid-cols-[0.72fr_1.28fr] md:py-16">
        ...
        <div className="grid gap-4 border-t border-[var(--line)] pt-4 sm:grid-cols-2">
          ...
          <a href="https://github.com/SAK-124" target="_blank" rel="noreferrer" className="rounded-[1.4rem] border border-[var(--line)] bg-[var(--surface)] p-5 transition-transform duration-300 hover:-translate-y-[1px] active:scale-[0.99]">
